  ...
  return (
    <div className="w-full max-w-sm lg:max-w-md lg:text-start">
      ...
      <div className="z-10 flex w-full max-w-md flex-col justify-center gap-3 lg:flex-row xl:justify-start">
        <button className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold transition-all">
        ...
        <button className="border-border text-foreground hover:bg-secondary inline-flex items-center justify-center bg-white/10 px-5 py-2.5 text-sm font-semibold transition-colors">
          EXPLORE CHANNEL
        </button>
      </div>
    </div>
